...
var MultiplayerServerPlugin = /*#__PURE__*/function () {
  function MultiplayerServerPlugin(room) {
    _classCallCheck(this, MultiplayerServerPlugin);

    this.room = void 0;
    this.room = room;
  }

  _createClass(MultiplayerServerPlugin, [{
    key: "getRoom",
    ...
    value: function _getMessageNamespace(component, type) {
      return 'entity.' + component.entityId + '.' + component.constructor.name + '.' + type;
    }
  }]);

  return MultiplayerServerPlugin;
}();

exports["default"] = MultiplayerServerPlugin;